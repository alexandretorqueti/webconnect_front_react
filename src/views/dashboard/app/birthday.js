                                                    ...
                                                    <div className="iq-birthday-block">
                                                        <div className="d-flex align-items-center justify-content-between">
                                                            <div className="d-flex align-items-center">
                                                                <Link to="#">
                                                                    <img src={user5} alt="profile-img" className="img-fluid"/>
                                                                </Link>
                                                ...
                                                <Card.Body>
                                                        <div className="iq-birthday-block">
                                                            <div className="d-flex align-items-center justify-content-between">
                                                                <div className="d-flex align-items-center">
                                                                    <Link to="#">
                                                                        <img src={user6} alt="profile-img" className="img-fluid"/>
                                                                    </Link>
                                                                    <div className="friend-info ms-0 ms-md-3 mt-md-0 mt-2">
                                                                        <h5>Petey Cruiser</h5>
                                                                        <p className="mb-0">Today</p>
                                                ...
                                                <Card.Body>
                                                    <div className="iq-birthday-block">
                                                        <div className="d-flex align-items-center justify-content-between">
                                                            <div className="d-flex align-items-center">
                                                                <Link to="#">
                                                                    <img src={user7} alt="profile-img" className="img-fluid"/>
                                                                </Link>
                                                                <div className="friend-info ms-0 ms-md-3 mt-md-0 mt-2">
                                                                    <h5>Petey Cruiser</h5>
                                                ...
                                                <Card.Body>
                                                        <div className="iq-birthday-block">
                                                            <div className="d-flex align-items-center justify-content-between">
                                                                <div className="d-flex align-items-center">
                                                                    <Link to="#">
                                                                        <img src={user8} alt="profile-img" className="img-fluid"/>
                                                                    </Link>
                                                                    <div className="friend-info ms-0 ms-md-3 mt-md-0 mt-2">
                                                                        <h5>Paul Molive</h5>
                                                                        <p className="mb-0">Tomorrow</p>
                                                ...
                                                <Card.Body>
                                                        <div className="iq-birthday-block">
                                                            <div className="d-flex align-items-center justify-content-between">
                                                                <div className="d-flex align-items-center">
                                                                    <Link to="#">
                                                                        <img src={user9} alt="profile-img" className="img-fluid"/>
                                                                    </Link>
                                                                    <div className="friend-info ms-0 ms-md-3 mt-md-0 mt-2">
                                                                        <h5>Paige Turner</h5>
