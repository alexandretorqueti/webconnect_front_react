                                ...
                                <Card className=" card-block card-stretch card-height">
                                    ...
                                    <Card.Body>
                                        <ul className="music-lists m-0 p-0">
                                            ...
                                            <li className="d-flex mb-4 align-items-center">
                                                <div className="user-img img-fluid">
                                                    <img src={imgl2} alt="story-img" className="rounded-circle avatar-40"/>
                                                </div>
                                                <div className="d-flex justify-content-between w-100">
                                                    <div className="ms-3">
                                            ...
                                            <li className="d-flex mb-4 align-items-center">
                                                <div className="user-img img-fluid">
                                                    <img src={imgl3} alt="story-img" className="rounded-circle avatar-40"/>
                                                </div>
                                                <div className="d-flex justify-content-between w-100">
                                                    <div className="ms-3">
                                            ...
                                            <li className="d-flex mb-4 align-items-center">
                                                <div className="user-img img-fluid">
                                                    <img src={imgl4} alt="story-img" className="rounded-circle avatar-40"/>
                                                </div>
                                                <div className="d-flex justify-content-between w-100">
                                                    <div className="ms-3">
                                                        <h6>Dritin</h6>
                                            ...
                                            <li className="d-flex mb-4 align-items-center">
                                                <div className="user-img img-fluid">
                                                    <img src={imgl5} alt="story-img" className="rounded-circle avatar-40"/>
                                                </div>
                                                <div className="d-flex justify-content-between w-100">
                                                    <div className=" ms-3">
                                                        <h6>Bones</h6>
                                            ...
                                            <li className="d-flex align-items-center">
                                                <div className="user-img img-fluid">
                                                    <img src={imgl6} alt="story-img" className="rounded-circle avatar-40"/>
                                                </div>
                                                <div className="d-flex justify-content-between w-100">
                                                    <div className="ms-3">
                                                        <h6>Hozier</h6>
                            ...
                            <Col md="8">
                                <Card className=" card-block card-stretch card-height">
                                    <Card.Body className=" p-0  ">
                                        <Link to="#">
                                            <img src={img48} alt="story-img" className="img-fluid rounded h-100 w-100"/>
                                        </Link>
                                    </Card.Body>
                                </Card>
                            </Col>
                                    ...
                                    <Card.Body>
                                            <Swiper 
                                                ...
                                                <SwiperSlide className="text-center">
                                                    <div className="music-thumbnail position-relative mb-3">
                                                        <Link to="#">
                                                            <img src={imgr8} alt="music-thumb" className="img-fluid w-100"/>
                                                        </Link>
                                                        <div className="play-btn">
                                                            <Link to="#">
                                                                <i className="ri-play-fill text-white"></i>
                                                ...
                                                <SwiperSlide className="text-center">
                                                    <div className="music-thumbnail position-relative mb-3">
                                                            <Link to="#">
                                                                <img src={imgr1} alt="music-thumb" className="img-fluid w-100"/>
                                                            </Link>
                                                        <div className="play-btn">
                                                            <Link to="#">
                                                                <i className="ri-play-fill text-white"></i>
                                                ...
                                                <SwiperSlide className="text-center">
                                                    <div className="music-thumbnail position-relative mb-3">
                                                        <Link to="#">
                                                            <img src={imgr2} alt="music-thumb" className="img-fluid w-100"/>
                                                        </Link>
                                                        <div className="play-btn">
                                                            <Link to="#">
                                                                <i className="ri-play-fill text-white"></i>
                                                ...
                                                <SwiperSlide className="text-center">
                                                    <div className="music-thumbnail position-relative mb-3">
                                                        <Link to="#">
                                                            <img src={imgr7} alt="music-thumb" className="img-fluid w-100"/>
                                                        </Link>
                                                        <div className="play-btn">
                                                            <Link to="#">
                                                                <i className="ri-play-fill text-white"></i>
                                    ...
                                    <Card.Body>
                                        <Swiper 
                                            ...
                                            <SwiperSlide className="text-center">
                                                <div className="music-thumbnail position-relative mb-3">
                                                    <Link to="#">
                                                        <img src={imgr3} alt="music-thumb" className="img-fluid w-100"/>
                                                    </Link>
                                                    <div className="play-btn">
                                                        <Link to="#">
                                                            <i className="ri-play-fill text-white"></i>
                                            ...
                                            <SwiperSlide className="text-center">
                                                <div className="music-thumbnail position-relative mb-3">
                                                    <Link to="#">
                                                        <img src={imgr4} alt="music-thumb" className="img-fluid w-100"/>
                                                    </Link>
                                                    <div className="play-btn">
                                                        <Link to="#">
                                                            <i className="ri-play-fill text-white"></i>
                                            ...
                                            <SwiperSlide className="text-center">
                                                <div className="music-thumbnail position-relative mb-3">
                                                    <Link to="#">
                                                        <img src={imgr5} alt="music-thumb" className="img-fluid w-100"/>
                                                    </Link>
                                                    <div className="play-btn">
                                                        <Link to="#">
                                                            <i className="ri-play-fill text-white"></i>
                                            ...
                                            <SwiperSlide className="text-center">
                                                <div className="music-thumbnail position-relative mb-3">
                                                    <Link to="#">
                                                        <img src={imgr6} alt="music-thumb" className="img-fluid w-100"/>
                                                    </Link>
                                                    <div className="play-btn">
                                                        <Link to="#">
                                                            <i className="ri-play-fill text-white"></i>
