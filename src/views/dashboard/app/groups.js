                        ...
                        <div className="d-grid gap-3 d-grid-template-1fr-19">
                            <Card className="mb-0">
                                ...
                                <Card.Body className=" text-center">
                                    <div className="group-icon">
                                        <img src={gi1} alt="profile-img" className="rounded-circle img-fluid avatar-120"/>
                                    </div>
                                    <div className="group-info pt-3 pb-3">
                                        <h4><Link to="/dashboards/app/group-detail">Designer</Link></h4>
                            ...
                            <div className="card mb-0">
                                ...
                                <div className="card-body text-center">
                                    <div className="group-icon">
                                        <img src={gi2} alt="profile-img" className="rounded-circle img-fluid avatar-120"/>
                                    </div>
                                    <div className="group-info pt-3 pb-3">
                                        <h4><Link to="/dashboards/app/group-detail">R & D</Link></h4>
                                        <p>Lorem Ipsum data</p>
                                    </div>
                                    <div className="group-details d-inline-block pb-3">
                                        <ul className="d-flex align-items-center justify-content-between list-inline m-0 p-0">
                            ...
                            <Card className=" mb-0">
                                ...
                                <Card.Body className=" text-center">
                                    <div className="group-icon">
                                        <img src={gi3} alt="profile-img" className="rounded-circle img-fluid avatar-120"/>
                                    </div>
                                    <div className="group-info pt-3 pb-3">
                                        <h4><Link to="/dashboards/app/group-detail">Graphics</Link></h4>
                                        <p>Lorem Ipsum data</p>
                                    </div>
                                    <div className="group-details d-inline-block pb-3">
                                        <ul className="d-flex align-items-center justify-content-between list-inline m-0 p-0">
                            ...
                            <div className="card mb-0">
                                ...
                                <div className="card-body text-center">
                                    <div className="group-icon">
                                        <img src={gi4} alt="profile-img" className="rounded-circle img-fluid avatar-120"/>
                                    </div>
                                    <div className="group-info pt-3 pb-3">
                                        <h4><Link to="/dashboards/app/group-detail">Developer</Link></h4>
                                        <p>Lorem Ipsum data</p>
                                    </div>
                                    <div className="group-details d-inline-block pb-3">
                                        <ul className="d-flex align-items-center justify-content-between list-inline m-0 p-0">
                            ...
                            <Card className=" mb-0">
                                ...
                                <Card.Body className="text-center">
                                    <div className="group-icon">
                                        <img src={gi5} alt="profile-img" className="rounded-circle img-fluid avatar-120"/>
                                    </div>
                                    <div className="group-info pt-3 pb-3">
                                        <h4><Link to="/dashboards/app/group-detail">Tester</Link></h4>
                                        <p>Lorem Ipsum data</p>
                                    </div>
                                    <div className="group-details d-inline-block pb-3">
                                        <ul className="d-flex align-items-center justify-content-between list-inline m-0 p-0">
                            ...
                            <Card className="mb-0">
                                ...
                                <Card.Body className="text-center">
                                    <div className="group-icon">
                                        <img src={gi6} alt="profile-img" className="rounded-circle img-fluid avatar-120"/>
                                    </div>
                                    <div className="group-info pt-3 pb-3">
                                        <h4><Link to="/dashboards/app/group-detail">Events</Link></h4>
                                        <p>Lorem Ipsum data</p>
                                    </div>
                                    <div className="group-details d-inline-block pb-3">
                                        <ul className="d-flex align-items-center justify-content-between list-inline m-0 p-0">
                            ...
                            <Card>
                                ...
                                <Card.Body className=" text-center">
                                    <div className="group-icon">
                                        <img src={gi7} alt="profile-img" className="rounded-circle img-fluid avatar-120"/>
                                    </div>
                                    <div className="group-info pt-3 pb-3">
                                        <h4><Link to="/dashboards/app/group-detail">Coder</Link></h4>
                                        <p>Lorem Ipsum data</p>
                                    </div>
                                    <div className="group-details d-inline-block pb-3">
                                        <ul className="d-flex align-items-center justify-content-between list-inline m-0 p-0">
                            ...
                            <Card>
                                ...
                                <Card.Body className=" text-center">
                                    <div className="group-icon">
                                        <img src={gi8} alt="profile-img" className="rounded-circle img-fluid avatar-120"/>
                                    </div>
                                    <div className="group-info pt-3 pb-3">
                                        <h4><Link to="/dashboards/app/group-detail">Themes</Link></h4>
                                        <p>Lorem Ipsum data</p>
                                    </div>
                                    <div className="group-details d-inline-block pb-3">
                                        <ul className="d-flex align-items-center justify-content-between list-inline m-0 p-0">
                            ...
                            <Card>
                                ...
                                <Card.Body className="text-center">
                                    <div className="group-icon">
                                        <img src={gi9} alt="profile-img" className="rounded-circle img-fluid avatar-120"/>
                                    </div>
                                    <div className="group-info pt-3 pb-3">
                                        <h4><Link to="/dashboards/app/group-detail">Review</Link></h4>
                                        <p>Lorem Ipsum data</p>
                                    </div>
                                    <div className="group-details d-inline-block pb-3">
                                        <ul className="d-flex align-items-center justify-content-between list-inline m-0 p-0">
